    ...
    return (
      <div className="min-h-screen bg-anti-flash-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-polynesian-blue/70">The landing page you're looking for doesn't exist.</p>
        </div>
      </div>
    )
  }
          ...
          >
            <div className="bg-white rounded-lg shadow-sm p-6 text-center border border-gray-200">
              ...
              <div className="mt-6 pt-4 border-t border-gray-100">
                <Link 
                  to={`/${user.username}`}
                  className="flex items-center justify-center space-x-2 text-picton-blue hover:text-picton-blue/80 transition-colors"
                >
